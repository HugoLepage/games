...
export default function Navigation({ children }: { children: React.ReactNode; }) {
    ...
    return (
        <div className="flex items-center justify-center gap-12">
            ...
            <div className={clsx("hidden lg:flex gap-4", isOpen ? "block" : "hidden")}>
                {children}
            </div>
            ...
            <dialog
                ...
                className={clsx("lg:hidden absolute z-50 w-full h-full flex flex-col gap-4 top-0 bg-zinc-900/20 backdrop-blur-md", isOpen ? "block" : "hidden")}>
